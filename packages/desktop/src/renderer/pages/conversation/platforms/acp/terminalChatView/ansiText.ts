...
/**
 * Minimal ANSI SGR parser for statusline output. Turns a single line of
 * ANSI-colored text into styled segments the HUD status bar can render as
 * spans. Handles the SGR subset statusline scripts actually emit (reset,
 * bold, dim, italic, underline, 16-color foregrounds); any other escape
