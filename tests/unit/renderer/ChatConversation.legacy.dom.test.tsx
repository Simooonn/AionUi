...
describe('ChatConversation legacy runtime rendering', () => {
  ...
  // ace: ACP model controls live in the sendbox toolbar pills — the header
  // must NOT mount a second model selector for ACP conversations.
  it('renders no header model selector for ACP conversations', () => {
    usePresetAssistantInfoMock.mockReturnValue({
      info: {
        name: 'Research Assistant',
        logo: '📚',
