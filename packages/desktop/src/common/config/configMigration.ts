...
const LEGACY_CHANNEL_KEYS = [
  ...
  // ace:start lark_intl legacy channel preference keys (Lark International)
...
// ace: 'lark_intl' included so legacy Lark International settings migrate too
const LEGACY_CHANNEL_PLATFORMS = ['telegram', 'lark', 'lark_intl', 'dingtalk', 'weixin', 'wecom'] as const;
